...
export default function Navbar() {
    ...
    return (
        <nav className="bg-gradient-to-r from-gray-900 via-gray-900 to-gray-800 border-b border-violet-500/20 backdrop-blur-sm px-8 py-5 flex items-center justify-between sticky top-0 z-50 shadow-lg shadow-violet-500/5">
            ...
            {/* Logout Button */}
            <button 
                className="px-5 py-2 text-sm font-semibold bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-red-500/30 active:scale-95 flex items-center gap-2"
            >
                Logout
            </button>
        </nav>
