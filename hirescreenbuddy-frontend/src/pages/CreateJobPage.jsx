...
import { createJob, getAllJobs } from '../api/api'
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900 text-white p-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-16">
                    <div className="mb-8">
                        <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-white to-violet-300 bg-clip-text text-transparent">Create Job Description</h1>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="8"
                                    className="w-full bg-gray-800/50 border border-gray-700/50 rounded-xl px-5 py-3 text-white text-sm focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all resize-none backdrop-blur"
                                />
                            </div>
                ...
                {/* Jobs List Section */}
                <div>
                    <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-white to-violet-300 bg-clip-text text-transparent">Job Descriptions</h2>
                    <p className="text-gray-400 mb-8">Manage your open positions</p>
                            ...
                            {jobs.map(job => {
                                ...
                                return (
                                    <div key={job.id} className="bg-gradient-to-br from-gray-900/60 to-gray-800/30 border border-violet-500/20 rounded-xl p-6 hover:border-violet-500/40 transition-all group hover:shadow-lg hover:shadow-violet-500/10 hover:-translate-y-1">
                                        <h3 className="text-white font-semibold mb-1 group-hover:text-violet-300 transition-colors">{job.title}</h3>
